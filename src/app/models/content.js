...
const Content = new Schema({
    ...
    aboutusHeading1: { type: String},
    aboutusContent1: { type: String},
    aboutusHeading2: { type: String},
    aboutusContent2: { type: String},
    aboutusHeading3: { type: String},
    aboutusContent3: { type: String},
